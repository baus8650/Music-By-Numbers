...
class MatrixViewController: UIViewController, UICollectionViewDelegateFlowLayout {
...
//        generateMatrix(rowString: "t50e96137824")
        ...
        print("THIS IS THE ROW \(userRow.row[0]), THIS IS THE PR LABELS \(prLabels), AND THIS IS THE IRI LABELS \(iriLabels)")
    ...
    @IBAction func generatePressed(_ sender: UIButton) {
        matrixViewModel?.generateMatrix(rowString: rowTextField.text!)
